<?php
	...
	$freemius_site_url = $fs->has_paid_plan() ?
		'https://extra.com/wordpress/' :
		// Insights platform information.
		'https://extra.com/wordpress/usage-tracking/';
	...
	$freemius_link = '<a href="' . $freemius_site_url . '" target="_blank" tabindex="1">extra.com</a>';
...
<div id="fs_connect"
	...
	<div class="fs-visual">
		...
		<img class="fs-connect-logo" width="80" height="80" src="//img.extra.com/connect-logo.png"/>
	</div>
...
//			),
	...
	<?php endif ?>
	<div class="fs-terms">
		<a href="https://extra.com/privacy/" target="_blank"
		   tabindex="1"><?php _efs( 'privacy-policy', $slug ) ?></a>
		&nbsp;&nbsp;-&nbsp;&nbsp;
		<a href="https://extra.com/terms/" target="_blank" tabindex="1"><?php _efs( 'tos', $slug ) ?></a>
	</div>
</div>
