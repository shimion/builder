...
//		define( 'WP_FS__LOCALHOST_IP', WP_FS__VVV_DEFAULT_PUBLIC_IP );
	 ...
	 * Domain / URL / Address
	 */
	define( 'WP_FS__DOMAIN_PRODUCTION', 'wp.extra.com' );
	define( 'WP_FS__ADDRESS_PRODUCTION', 'https://' . WP_FS__DOMAIN_PRODUCTION );

	if ( ! defined( 'WP_FS__DOMAIN_LOCALHOST' ) ) {
		define( 'WP_FS__DOMAIN_LOCALHOST', 'wp.extra' );
	}
	...
	if ( ! defined( 'WP_FS__API_ADDRESS_LOCALHOST' ) ) {
		define( 'WP_FS__API_ADDRESS_LOCALHOST', 'http://api.extra:8080' );
	}
	if ( ! defined( 'WP_FS__API_SANDBOX_ADDRESS_LOCALHOST' ) ) {
		define( 'WP_FS__API_SANDBOX_ADDRESS_LOCALHOST', 'http://sandbox-api.extra:8080' );
	}
