...
//	set_site_transient( 'update_plugins', null );
	...
	class FS_Plugin_Updater {
		...
		function __construct( Freemius $extra ) {
			$this->_fs = $extra;

			$this->_logger = FS_Logger::get_logger( WP_FS__SLUG . '_' . $extra->get_slug() . '_updater', WP_FS__DEBUG_SDK, WP_FS__ECHO_DEBUG_SDK );
		 ...
		 * filter white-list all domains including "api.extra".
		 *
		...
		function http_request_host_is_external_filter( $allow, $host, $url ) {
			return ( false !== strpos( $host, 'extra' ) ) ? true : $allow;
		}
